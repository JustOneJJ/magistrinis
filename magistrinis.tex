...
\title{Vaizdų apdorojimas taikant gilius neuroninius tinklus}
\titleineng{Image Processing by Deep Neural Networks}
\status{X kurso Y grupės studentas}
\author{Justas Janušauskas}
% \secondauthor{Vardonis Pavardonis}   % Pridėti antrą autorių
\supervisor{doc. dr. Olga Kurasova}
...
Testas \cite{amershi2015modeltracker}.
